...
> Create a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [gamma][gamma] distribution.
...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-gamma@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-gamma/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-gamma@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-gamma/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-gamma@umd/browser.js"></script>
```
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [gamma][gamma] distribution with parameters `alpha` (shape) and `beta` (rate).
...
Returns a `function` for creating [readable streams][readable-stream] which generate pseudorandom numbers drawn from a [gamma][gamma] distribution.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-gamma.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-gamma

[test-image]: https://github.com/stdlib-js/random-streams-gamma/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-streams-gamma/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-streams-gamma/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-streams-gamma?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-gamma.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-streams-gamma/main
...
[cli-section]: https://github.com/stdlib-js/random-streams-gamma#cli
[cli-url]: https://github.com/stdlib-js/random-streams-gamma/tree/cli
[@stdlib/random-streams-gamma]: https://github.com/stdlib-js/random-streams-gamma/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-gamma/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-gamma/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-gamma/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-gamma/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-gamma/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-gamma/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-gamma/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-gamma/main/LICENSE
