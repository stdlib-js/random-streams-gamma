...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a gamma distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( alpha: number, beta: number, options?: Options );
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating gamma distributed pseudorandom numbers.
	*/
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( alpha: number, beta: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( alpha: number, beta: number, options?: Options ): RandomStream; // callable
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a gamma distribution.
	*
	* @param alpha - shape parameter
	* @param beta - rate parameter
	* @param options - stream options
	...
	*/
	objectMode( alpha: number, beta: number, options?: Options ): RandomStream;
}
